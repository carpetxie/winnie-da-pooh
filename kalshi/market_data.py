"""
kalshi/market_data.py

Fetches settled markets from Kalshi API and computes market volatility metrics
for confidence steering calibration.

Usage:
    from kalshi.market_data import fetch_all_settled_markets, calculate_volatility
"""
